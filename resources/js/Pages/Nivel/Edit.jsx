...
const EditEstructura = ({ auth, nivel }) => {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('niveles.update', nivel));
    }
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
                <div className='flex justify-between'>
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">ACTUALIZAR NIVEL</h2>
                        ...
                        <div className="p-6 text-gray-900">
                            <div>
                                <form onSubmit={submit} className='space-y-3'>
                                    ...
                                    <InputLabel htmlFor="importe" value="Nombre" />
                                    <TextInput
                                        id="importe"
                                        type="number"
                                        name="importe"
